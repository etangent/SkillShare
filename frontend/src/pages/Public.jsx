  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <main className='container mx-auto mt-8 p-8 bg-white shadow-md rounded-lg'>
        <h1 className='text-5xl font-bold text-gray-800 mb-6 text-center'>Welcome to SkillMatcher!</h1>
        <p className='text-lg text-gray-700 mb-6 text-center'>
          Unlock your potential and connect with a vibrant community eager to learn and share skills. Whether you're a seasoned expert or a curious beginner, SkillMatcher is your gateway to endless possibilities.
        </p>
