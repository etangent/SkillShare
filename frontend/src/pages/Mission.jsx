  ...
  return (
    <div className='min-h-screen bg-background'>
      ...
      <main className='container mx-auto mt-8 p-4 bg-white shadow-md rounded-lg'>
        ...
        <h2 className='text-2xl font-semibold text-gray-800 mt-8 mb-4'>What is Syncora?</h2>
        <p className='text-lg text-gray-700 mb-4'>
          Syncora is a social media platform designed to facilitate the sharing of abilities and hobbies among a diverse group of people. Users can create accounts with multiple “skills” that represent their abilities, categorized for easy navigation. The app features a scrolling interface that recommends skills based on user preferences.
        </p>
        <p className='text-lg text-gray-700 mb-4'>
